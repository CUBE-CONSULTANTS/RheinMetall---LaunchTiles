		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Launchpad",
									"targetURL": "#launchpadlaunchpad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"launchpadlaunchpad-display": {
								"semanticObject": "launchpadlaunchpad",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=launchpad.launchpad",
									"url": sap.ui.require.toUrl("launchpad/launchpad")
								}
							}
						}
					}
